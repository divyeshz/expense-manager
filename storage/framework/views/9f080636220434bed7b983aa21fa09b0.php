    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo e(route('changePasswordForm')); ?>">
                    <i class=""></i>
...
<!-- End of Topbar -->
<?php /**PATH /Users/ztlab60/ExpenseManager/resources/views/components/header.blade.php ENDPATH**/ ?>